export const metadata = {
  title: "Creating a Next.js 14 App with MDX",
  publishDate: "2024-07-12",
  description:
    "Learn how to create a Next.js 14 app that generates static MDX pages from documents stored in a local directory.",
  category: "MDX",
};
...
```bash
npm install @next/mdx @types/mdx gray-matter react-syntax-highlighter remark-gfm styled-components @mdx-js/loader
